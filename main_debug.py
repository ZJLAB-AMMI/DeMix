...
def main(conf):
    ...
    method_str += '_da' if conf.data_augmentation else '_nda'
...
if __name__ == '__main__':
    ...
    # netname_set = ['resnet34', 'resnet101']
    ...
    conf = get_config(dataset=dataset, netname=netname, mixmethod=mixmethod, gpu_ids=gpu_ids, debug=debug)
    set_env(conf)
