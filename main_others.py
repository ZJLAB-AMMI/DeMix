...
if __name__ == '__main__':
    ...
    # conf.weight_decay = 1e-4
    gpu_ids = '6,7'
    netname_set = ['inception_v3', 'densenet121']
    dataset_set = ['car', 'aircraft']
    mixmethod_set = ['baseline', 'mixup', 'cutmix', 'saliencymix', 'detrmix']
    for netname in netname_set:
        for dataset in dataset_set:
            for mixmethod in mixmethod_set:
                ...
                method_str += '_bs{}_wd{}'.format(conf.batch_size, conf.weight_decay)
